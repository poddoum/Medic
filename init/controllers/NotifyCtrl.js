...
// POST localhost:3000/reminder
exports.sendReminder = function(req, res, next){
	...
	if(req.body.notifyNumber){
		...
		var message = greeting + ' ' + req.body.userName + ', ' + req.body.dosage + ' ' + req.body.pillName + ' are ready to be dispensed';
		var to = '+1' + req.body.notifyNumber ;
